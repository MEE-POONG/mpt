                        ...
                        <Slider {...settingsLanguages}>
                            <div className="px-2 py-5">
                                <div className="item px-2">
                                    ...
                                    <h4 className='truncate'>Html5</h4>
                            ...
                            <div className="px-2 py-5">
                                <div className="item px-2">
                                    ...
                                    <h4 className='truncate'>Flutter</h4>
                                    <div className="icon-button">
                            ...
                            <div className="px-2 py-5">
                                <div className="item px-2">
                                    ...
                                    <h4 className='truncate'>Framework</h4>
                                    <div className="icon-button">
